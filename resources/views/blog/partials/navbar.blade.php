<header class="blog-header py-3 border-bottom">
    <div class="row flex-nowrap justify-content-between align-items-center">
        <div class="col-4 pt-1">
            <p class="my-auto">
                <a href="https://twitter.com/itzmevishu" class="pr-3 text-decoration-none" target="_blank" rel="noopener">
                ...
                <a href="https://github.com/itzmevishu/" class="text-decoration-none" target="_blank" rel="noopener">
